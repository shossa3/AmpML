...
Classification.py - contains the model implementation, data loading, and traning. 
Inference.py - consists of an example of loading the model and running inference on example audio. 
